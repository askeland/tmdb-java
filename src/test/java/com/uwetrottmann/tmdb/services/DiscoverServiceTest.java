...
public class DiscoverServiceTest extends BaseTestCase {
    ...
    @Test
    public void test_discover_movie() throws ParseException, IOException {
        MovieResultsPage results = getManager().discoverService().discoverMovie(false, true, null, 1,
                ...
                null, new AppendToDiscoverResponse(10749), null, null, null).execute().body();
    ...
    @Test
    public void test_discover_tv() throws ParseException, IOException {
        TvResultsPage results = getManager().discoverService().discoverTv(null, null,
                ...
                JSON_STRING_DATE.parse("2014-01-01")).execute().body();
